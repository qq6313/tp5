<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpStudy\WWW\twothink\public/../application/home/view/default/server\index.html";i:1507445848;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <!--导航结束-->
    <?php if(empty($document) || (($document instanceof \think\Collection || $document instanceof \think\Paginator ) && $document->isEmpty())): ?>
    没有更多数据了
    <?php else: foreach($document as $i=>$d):?>
    ...
    <button class="btn btn-default btn-block btn_load" onclick="loadPage(<?php echo $no; ?>)">获取更多</button>
