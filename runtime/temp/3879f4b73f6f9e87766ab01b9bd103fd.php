<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/rental\index.html";i:1507449725;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tr>
            ...
            <td><?php echo $expire['price']; ?></td>
            <td>
                <?php echo !empty($expire['type']) && $expire['type']==1?"出租":"出售"; ?>
            </td>
            <td><img src="<?php echo $expire['logo']; ?>" alt="" width="100px"></td>

            <td><?php echo $expire['content']; ?></td>
            <td><?php echo $expire['description']; ?></td>
            <td><?php echo $expire['tel']; ?></td>
            <td><?php echo $expire['end_time']; ?></td>
            <td>
