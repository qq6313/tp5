<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/vili\index.html";i:1507434082;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tr data-id="<?php echo $expire['id']; ?>">
            <td><input class="ids row-selected" type="checkbox" name="id[]" id="" value="<?php echo $expire['id']; ?>"> </td>
            <td><?php echo $expire['id']; ?></td>
            <td><?php echo $expire['realname']; ?></td>
            <td><?php echo $expire['tel']; ?></td>
            <td><?php echo $expire['num']; ?></td>
            <td>
                <?php echo !empty($expire['status']) && $expire['status']==1?"已通过":"未通过"; ?>
            </td>
            <td>
                <?php if($expire['relation']==1){
                echo "本人";
                }elseif($expire['relation']==2){
                echo "亲戚";
                }elseif($expire['relation']==3){
                echo "租户";
                }?>
            </td>
            <td>
                <a  href="javascript:;" class="tongguo">通过</a>
            </td>
        </tr>
...
<script type="text/javascript">
    $(function() {
        $('.tongguo').click(function () {
           ...
           $.get(
               '/admin/vili/edit.html',{'id':id},function (data) {
