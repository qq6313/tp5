<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpStudy\WWW\twothink\public/../application/home/view/default/my\index.html";i:1507451001;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container">
        ...
        <div class="row text-center myLabel">
            ...
            <div class="col-xs-4 label-success"><a href="<?php echo url('expire/my'); ?>"><span class="iconfont">&#xe609;</span>我的报修</a></div>
        ...
        <div>
            <ul class="list-group fuwuList">
                ...
                <li class="list-group-item"><a href="<?php echo url('vili/index'); ?>" class="text-danger"><span class="iconfont">&#xe60a;</span>业主认证</a> </li>
                ...
                <li class="list-group-item"><a href="<?php echo url('logout/index'); ?>" class="text-info"><span class="iconfont">&#xe607;</span>注销登录</a></li>
            </ul>
        </div>
    </div>
</div>
