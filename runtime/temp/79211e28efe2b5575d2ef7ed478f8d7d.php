<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/server\index.html";i:1507346090;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tr>
            ...
            <td><?php echo $expire['author']; ?></td>
            <td><?php echo $expire['total']; ?></td>
            <td>
                <?php echo !empty($expire['status']) && $expire['status']==1?"显示":"禁用"; ?>
            </td>
            <td><?php echo $expire['content']; ?></td>
            <td><?php echo time_format($expire['start_time']); ?></td>
            <td><?php echo time_format($expire['end_time']); ?></td>
            <td>
                ...
                <a class="confirm ajax-get" title="删除" href="<?php echo url('del?id='.$expire['id']); ?>">删除</a>
            </td>
        </tr>
