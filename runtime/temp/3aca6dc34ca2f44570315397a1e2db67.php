<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/server\add.html";i:1507347442;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        <label class="item-label">内容<span class="check-tips">（内容）</span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="content" value="<?php echo (isset($info['content']) && ($info['content'] !== '')?$info['content']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">作者<span class="check-tips">（作者）</span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="author" value="<?php echo (isset($info['author']) && ($info['author'] !== '')?$info['author']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">开始时间<span class="check-tips">（社区服务开始时间）</span></label>
        <div class="controls">
            <input type="date" class="text input-large" name="start_time" value="<?php echo (isset($info['start_time']) && ($info['start_time'] !== '')?$info['start_time']:''); ?>">
        </div>
    </div>
    <div class="form-item">
