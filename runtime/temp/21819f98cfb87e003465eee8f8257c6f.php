...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        <label class="item-label">电话号码<span class="check-tips">（工作人员用来联系您的电话号码）</span></label>
        <div class="controls">
    ...
    <div class="form-item">
        <label class="item-label">问题简述<span class="check-tips">（请简单描述一下您遇到的问题）</span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="des" value="<?php echo (isset($info['des']) && ($info['des'] !== '')?$info['des']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">主要内容<span class="check-tips">（请具体描述下您的问题）</span></label>
        <div class="controls">
