<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/rental\add.html";i:1507450176;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <input type="date" name="end_time"  value="<?php echo time_format($info['end_time']); ?>" placeholder="截止时间" />
        </div>
    </div>
    <div class="form-item">
